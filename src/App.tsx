...
const O = <img src={oImage} alt="Green circle" width="100" height="100"></img>  
const X = <img src={xImage} alt="Red X" width="100" height="100"></img>    
  ...
  return (
    ...
    <div className="App">  
      <div className={style.scoreBoard}> 
        <div style={{width: '50'}}>{<img src={xImage} alt="Red X" width="20" height="20"></img>   }  {XScore}</div>   
